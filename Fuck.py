...
def apv():
	try:
		...
		if kex in link:clear();main()
			...
			line()
			url_wa = "https://api.whatsapp.com/send?phone=+8801815057055&text="
			name = input(" Enter your Name : ")
			line()
			tks = ("Hi Atif Sir, I Need To Buy Your Paid AKING Tools Version 8.7.2 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)
